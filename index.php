...
?>
<title>AI-rchive Digital Library</title>
  ...
  <div class="container" id="main">
    <div class="row row-offcanvas row-offcanvas-left">
	  ...
	  <div class="col-md-9 col-lg-10 main"> 
		<div class="row mb-3">		 
			<div style="padding-top:150px; padding-left:200px" class="panel-body" >
			<h1><b>Admin User Login</b></h1>
			<p></P>
				<?php if ($loginMessage != '') { ?>
				...
				<form id="loginform" class="form-horizontal" role="form" method="POST" action="">                                    
					...
					<div style="margin-top:10px" class="form-group">      
						<input type="submit" name="login" value="Login" class="btn btn-info" style="background:#007bff;">
					</div>	
